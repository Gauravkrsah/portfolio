...
const MobileNavbar: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="p-6 sm:p-8 h-full overflow-auto flex flex-col bg-[#111111]">
      ...
      >
        <div className="p-6 sm:p-8 h-full overflow-auto flex flex-col bg-gradient-to-b from-[#0A0A0A] to-[#151515]">
          {/* Action section */}
          <div className="mb-10">
